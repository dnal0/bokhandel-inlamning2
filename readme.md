...
Om databasen skulle hantera 100 000 kunder istället för 10 skulle jag:
- Lägga till fler index (t.ex. på datum i beställningar och författare i böcker)
- Dela upp tabellerna med partitioning (t.ex. beställningar per år)
- Kanske fundera på read-replica för rapporter om det blir mycket trafik
- Lägga till användarroller och rättigheter istället för bara root
